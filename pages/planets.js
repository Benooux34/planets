...
// bg-[url('https://wallpaperbat.com/img/196032-space-wallpaper-free-hd-download-hq.jpg')]

function planets() {
  return (
    <div className="md:h-screen bg-gradient-to-b from-black via-gray-900 to-violet-900 bg-contain bg-repeat">
        <Head>
        ...
        >
            <SwiperSlide className="bg-black border border-white border-1 mx-5 flex flex-col justify-center items-center">
            ...
            <SwiperSlide className="bg-black border border-white border-1 mx-5 flex flex-col justify-center items-center">
                ...
                <motion.button whileHover={{scale: 1.1}} whileTap={{scale: 0.95}} className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-500 px-5 py-2 text-[25px]">Explorez !</motion.button>
            </SwiperSlide>
            <SwiperSlide className="bg-black border border-white border-1 mx-5 flex flex-col justify-center items-center">
